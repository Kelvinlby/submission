...
class MessageData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MessageData', package: const $pb.PackageName(_omitMessageNames ? '' : 'communication'), createEmptyInstance: create)
...
class ReturnData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReturnData', package: const $pb.PackageName(_omitMessageNames ? '' : 'communication'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'p', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.int get p => $_getIZ(0);
  @$pb.TagNumber(1)
  set p($core.int v) { $_setUnsignedInt32(0, v); }
  @$pb.TagNumber(1)
